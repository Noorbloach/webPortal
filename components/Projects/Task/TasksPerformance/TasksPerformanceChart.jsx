...
const TasksPerformanceChart = () => {
  ...
  return (
    <>
      <Chart options={options} series={series} type="radialBar" height={355} />
      <Box
        sx={{
          display: 'flex',
          alignItems: 'center',
      ...
      >
        <Box>
          ...
          <Typography fontWeight="500" fontSize="20px" as="h4">
            <ArrowDownwardIcon color="danger" style={{ position: 'relative', top: '3px' }} /> 30k
          </Typography>
        </Box>
        <Box>
          <Typography color="#A9A9C8" mb={1}>
          ...
          <Typography fontWeight="500" fontSize="20px" as="h4">
            <ArrowUpwardIcon color="success" style={{ position: 'relative', top: '3px' }} /> 40k
          </Typography>
        </Box>
        <Box>
          <Typography color="#A9A9C8" mb={1}>
          ...
          <Typography fontWeight="500" fontSize="20px" as="h4">
            <ArrowUpwardIcon color="success" style={{ position: 'relative', top: '3px' }} /> 60k
          </Typography>
        </Box>
      </Box>
    </>
